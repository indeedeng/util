...
public class VarExporterTest {
    ...
    private static class ExampleClass {
        ...
        public static int getStaticNotExported() {
            return staticNotExported;
        }
    ...
    private static class ExampleNeedingEscaping {
        ...
        public static String helloBulgaria() {
            return "Say Ŵhat?";
        }

        @Export(name = "foo:bar=hi", doc = ":::=test=:::")
        public static String yoSeps() {
            return "x:=y";
        }
    }
    ...
    private abstract static class AbstractClassImplementingInterface implements ExampleInterface {
    ...
    private static class ConcreteClassImplementingInterfaceAgain
            extends AbstractClassImplementingInterface implements ExampleInterface {}
    ...
    private static ManagedVariable<String> startTimeBackup =
            VarExporter.createStartTimeVariable(new Date());
    ...
    public void testExportInstance() {
        ...
        assertExportedNames(
                exporter, "ex1field", "ex1method", "static1field", "static1method", "myNameIsEarl");
    ...
    private void assertVariableNamesForTag(String tag, String... expectedNames) {
        ...
        VarExporter.withTag(tag).visitVariables(var -> variableNames.add(var.getName()));
    ...
    public void testTagWithNamespace() throws Exception {
        ...
        VarExporter.withTag("IAmAwesome")
                .visitVariables(
                        var -> {
    ...
    public void testExportInstanceMethods() throws Exception {
        ...
        // export field with a custom name
        exporter.export(
                instance, ExampleClass.class.getMethod("getNotExported"), "", "not-exported");
        assertExportedNames(exporter, "not-exported");
        assertEquals(0, (int) exporter.getValue("not-exported"));
        instance.notExported = 1;
        assertEquals(1, (int) exporter.getValue("not-exported"));
    ...
    public void testExportStaticFields() throws Exception {
        ...
        exporter.export(
                ExampleClass.class,
                ExampleClass.class.getField("staticNotExported"),
                "",
                "not-exported");
        assertExportedNames(exporter, "not-exported");
        ...
        // export field with default name
        exporter.export(
                ExampleClass.class, ExampleClass.class.getField("staticNotExported"), "", null);
    ...
    public void testExportStaticMethods() throws Exception {
        ...
        exporter.export(
                ExampleClass.class,
                ExampleClass.class.getMethod("getStaticNotExported"),
                "",
                "not-exported");
        assertExportedNames(exporter, "not-exported");
        ExampleClass.staticNotExported = 0;
        ...
        // export field with default name
        exporter.export(
                ExampleClass.class, ExampleClass.class.getMethod("getStaticNotExported"), "", null);
        assertExportedNames(exporter, "not-exported", "getStaticNotExported");
        assertEquals(1, (int) exporter.getValue("getStaticNotExported"));

        // export field with @Export
        exporter.export(
                ExampleClass.class, ExampleClass.class.getMethod("getStatic1"), "", "WONTUSE");
    ...
    public void testPrefix() {
        ...
        assertExportedNames(
                exporter, "prefix-static1field", "prefix-static1method", "prefix-myNameIsEarl");
        ExampleClass.static1 = 52473L;
    ...
    public void testExportMap() {
        ...
        assertEquals(
                "{1=one, 2=two, 524=five hundred twenty-four}",
                exporter.getValue("map").toString());
        Map<Long, String> map = exporter.getValue("map");

        assertThat(map.keySet(), Matchers.containsInAnyOrder(1L, 2L, 524L));
        assertThat(
                map.values(),
        ...
        assertThat(
                ...
                Matchers.containsInAnyOrder(
                        "blowoutMap#1=one",
                        "blowoutMap#2=two",
                        "blowoutMap#524=five hundred twenty-four",
    ...
    public void testCaching() {
        ...
        assertThat(
                ...
                Matchers.contains(
                        ...
                        "nodoc=hi",
                        "",
                        "# cached number (last update: 25000)",
                        "num=2",
                        "",
                        "# cached value (last update: 25000)",
                        "val=0"));
    }
    ...
    public void testParent() {
        ...
        VarExporter.forNamespace("bar")
                .export(ManagedVariable.<Long>builder().setName("mv").build());
        assertExportedNames(
                bar,
                "static1field",
                "static1method",
        ...
        assertExportedNames(
                exporter,
                "foo-bar-static1field",
                "foo-bar-static1method",
                "foo-bar-myNameIsEarl",
                "foo-bar-ex1method",
                "foo-bar-ex1field",
                "foo-bar-mv");
    }
    ...
    public void testIncludeGlobalGlobal() throws Exception {
        ...
        VarExporter.global()
                .setParentNamespace(VarExporter.global())
                .export(ExampleClass.class, "");
        VarExporter.forNamespace("foo")
                .setParentNamespace(VarExporter.forNamespace("foo"))
                .export(ExampleClass.class, "");
    }
    ...
    public void testForNamespaceWithClass() {
        ...
        assertExportedNames(
                exporter, "ex1field", "ex1method", "myNameIsEarl", "static1field", "static1method");

...
public class ViewExportedVariablesServletTest {
    ...
    private String getOutput(
            final ViewExportedVariablesServlet servlet, String namespace, String tag)
            throws IOException {
        ...
        replay(response);
        servlet.showVariables(
                "",
                response,
                namespace,
                tag,
                false,
                ViewExportedVariablesServlet.DisplayType.PLAINTEXT);
    ...
    public static class TagExamples {
        ...
        @Export(
                name = "ex2field",
                doc = "Example variable 2",
                tags = {"VEVST2"})
        public int ex2 = 2;

        @Export(
                name = "ex3field",
                doc = "Example variable 3",
                tags = {"VEVST3"})
        public int ex3 = 3;

        @Export(
                name = "ex4field",
                doc = "Example variable 4",
                tags = {"VEVST2"})
    ...
    public void testManagedVariables() throws IOException {
        final ManagedVariable<String> var1 =
                ManagedVariable.<String>builder().setName("test1").setValue("1").build();
        final ManagedVariable<String> var2 =
                ManagedVariable.<String>builder().setName("test2").setValue("2").build();
    ...
    public void testTags() throws IOException {
        final TagExamples examples = new TagExamples();
        VarExporter.global().export(examples, "");
        final ViewExportedVariablesServlet servlet = setupServlet();
    ...
    public void escapesHtmlInVariableNamesAndValues() throws IOException {
        ...
        VarExporter.global()
                .export(ManagedVariable.builder().setName(unescaped).setValue(unescaped).build());
    ...
    public void buildAlphaNumericNGramIndex() {
        ...
        final SetMultimap<String, Integer> actualTriGramIndex =
                ViewExportedVariablesServlet.buildAlphanumericNGramIndex(
                        Arrays.asList(
    ...
    public void alphanumericNGrams() {
        ...
        assertEquals(
                ...
                ViewExportedVariablesServlet.alphanumericNGrams("m1-3-/bi<</tri", 1)
                        .collect(Collectors.toList()));

        assertEquals(
                Arrays.asList("m1", "bi", "tr", "ri"),
                ViewExportedVariablesServlet.alphanumericNGrams("m1-3-/bi<</tri", 2)
                        .collect(Collectors.toList()));

        assertEquals(
                Arrays.asList("m1x", "1x3", "x3d", "3dc", "dca", "cas", "ase", "tri", "tri"),
                ViewExportedVariablesServlet.alphanumericNGrams("m1x3dCaSe-1-/bi<</tri?tri", 3)
                        .collect(Collectors.toList()));
    }

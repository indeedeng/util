package com.indeed.util.core.hash;
...
public class TestMurmurHash {
    ...
    public void testHash32ByteArrayIntInt() {
        for (int i = 0; i < input.length; i++) {
            int hash = MurmurHash.hash32(input[i], 0x71b4954d);
    ...
    public void testHash32ByteArrayInt() {
        for (int i = 0; i < input.length; i++) {
            int hash = MurmurHash.hash32(input[i]);
    ...
    public void testHash64ByteArrayIntInt() {
        for (int i = 0; i < input.length; i++) {
            long hash = MurmurHash.hash64(input[i], 0x344d1f5c);
            assertTrue(
                    String.format("Unexpected hash64 result for example %d: 0x%016x instead of 0x%016x", i, hash, results64_seed[i]),
    ...
    public void testHash64ByteArrayInt() {
        for (int i = 0; i < input.length; i++) {
            long hash = MurmurHash.hash64(input[i]);
            assertTrue(
                    String.format("Unexpected hash64 result for example %d: 0x%016x instead of 0x%016x", i, hash, results64_standard[i]),

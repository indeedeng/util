...
public class Closeables2 {
    ...
    /**
     * this is very similar to guava's {#link Closeables.closeQuietly()}, except with logging unlike
     * guava this swallows all Exceptions, not just IOExceptions. Error is still propagated.
     *
    ...
    /**
     * Close all {@link Closeable} objects provided in the {@code closeables} iterator. When
     * encountering an error when closing, write the message out to the provided {@code log}.
     *
    ...
    /**
     * Create a composite {@link Closeable} that will close all underlying {@code closeables}
     * references. The {@link Closeable#close()} method will perform a safe close of all wrapped
     * Closeable objects. This is needed since successive calls of the {@link #close(Closeable...)}
     ...
     * @deprecated Just use the lambda below in your own code. This method no longer uses the given
     *     logger, and no alternative is provided.
     */
    @Deprecated

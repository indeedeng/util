...
`gcc -m32 -shared -W1,-soname,libindeedmmap.so.1 -o libindeedmmap.so.1.0.1 com_indeed_util_mmap_MMapBuffer.o com_indeed_util_mmap_NativeMemoryUtils.o com_indeed_util_mmap_Stat.o`;

...
`gcc -shared -W1,-soname,libsquallmmap.so.1 -o libsquallmmap.so.1.0.1 com_indeed_util_mmap_MMapBuffer.o com_indeed_util_mmap_NativeMemoryUtils.o com_indeed_util_mmap_Stat.o`;

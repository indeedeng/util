...
public final class DoubleArray {
    ...
    public void get(final long index, final DoubleArray doubles, final long start, final long length) {
    ...
    public void set(final long index, final DoubleArray doubles, final long start, final long length) {
        doubles.buffer.getBytes(index*TYPE_SIZE, this.buffer, start*TYPE_SIZE, length*TYPE_SIZE);
    }

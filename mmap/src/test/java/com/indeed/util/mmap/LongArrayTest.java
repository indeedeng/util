...
public class LongArrayTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        longArrays[1] = new MMapBuffer(file, 0, length*size, FileChannel.MapMode.READ_WRITE, ByteOrder.LITTLE_ENDIAN).memory().longArray(0L, length);
        longArrays[2] = new NativeBuffer(length*size, ByteOrder.LITTLE_ENDIAN).memory().longArray(0L, length);
    }

...
public class IntArrayTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        intArrays[1] = new MMapBuffer(file, 0, length*size, FileChannel.MapMode.READ_WRITE, ByteOrder.LITTLE_ENDIAN).memory().intArray(0L, length);
        intArrays[2] = new NativeBuffer(length*size, ByteOrder.LITTLE_ENDIAN).memory().intArray(0L, length);
    }

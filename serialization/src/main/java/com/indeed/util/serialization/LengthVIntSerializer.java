...
/**
 * Serializer that writes 0-254 as one byte. Any value greater than 254 or less than 0 is written as
 * 5 bytes.
 *
 * @author jplaisance
 */
public final class LengthVIntSerializer implements Serializer<Integer> {
    private static final Logger log = LoggerFactory.getLogger(LengthVIntSerializer.class);

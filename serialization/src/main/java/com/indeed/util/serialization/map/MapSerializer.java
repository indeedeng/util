...
public final class MapSerializer<K, V> implements Serializer<Map<K, V>> {
    ...
    public static <K, V> MapSerializer<K, V> hashMapSerializer(
            Serializer<K> keySerializer, Serializer<V> valueSerializer) {
        return new MapSerializer<K, V>(
                new CollectionSuppliers.HashMapSupplier<K, V>(), keySerializer, valueSerializer);
    }

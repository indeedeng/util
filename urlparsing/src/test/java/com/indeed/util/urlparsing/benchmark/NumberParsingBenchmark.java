...
public class NumberParsingBenchmark {
    ...
    private static final NumberParser indeedNumberParser =
            new NumberParser() {
                @Override
    ...
    private static final NumberParser javaNumberParser =
            new NumberParser() {
                @Override
                public float parseFloat(String line, int start, int end) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final CharSource intData =
                Resources.asCharSource(
                        Resources.getResource("text_with_ints.txt"), Charset.forName("UTF-8"));
        final CharSource floatData =
                Resources.asCharSource(
                        Resources.getResource("text_with_floats.txt"), Charset.forName("UTF-8"));
    ...
    public static void doNumberParsingBenchMark(
            final CharSource intData,
            final CharSource floatData,
            final Stopwatch stopwatchA,
            final Stopwatch stopwatchB,
            final NumberParser numberParser)
            throws IOException {

        final Integer numInts =
                intData.readLines(

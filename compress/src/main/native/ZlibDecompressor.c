...
#include "com_indeed_util_compress_zlib_ZlibDecompressor.h"
...
Java_com_indeed_util_compress_zlib_ZlibDecompressor_initIDs(
...
Java_com_indeed_util_compress_zlib_ZlibDecompressor_init(
...
JNIEXPORT void JNICALL
Java_com_indeed_util_compress_zlib_ZlibDecompressor_setDictionary(
...
Java_com_indeed_util_compress_zlib_ZlibDecompressor_inflateBytesDirect(
...
JNIEXPORT jlong JNICALL
Java_com_indeed_util_compress_zlib_ZlibDecompressor_getBytesRead(
	JNIEnv *env, jclass cls, jlong stream
	) {
...
JNIEXPORT jlong JNICALL
Java_com_indeed_util_compress_zlib_ZlibDecompressor_getBytesWritten(
	JNIEnv *env, jclass cls, jlong stream
	) {
...
JNIEXPORT jint JNICALL
Java_com_indeed_util_compress_zlib_ZlibDecompressor_getRemaining(
	JNIEnv *env, jclass cls, jlong stream
	) {
...
JNIEXPORT void JNICALL
Java_com_indeed_util_compress_zlib_ZlibDecompressor_reset(
	JNIEnv *env, jclass cls, jlong stream
	) {
...
JNIEXPORT void JNICALL
Java_com_indeed_util_compress_zlib_ZlibDecompressor_end(
	JNIEnv *env, jclass cls, jlong stream
	) {

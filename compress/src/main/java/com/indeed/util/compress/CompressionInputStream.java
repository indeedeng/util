 ...
 *
 * <p>Implementations are assumed to be buffered. This permits clients to reposition the underlying
 * input stream then call {@link #resetState()}, without having to also synchronize client buffers.
 */

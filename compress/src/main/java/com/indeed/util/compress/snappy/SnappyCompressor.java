...
/**
 * A {@link Compressor} based on the snappy compression algorithm. http://code.google.com/p/snappy/
 */
public class SnappyCompressor implements Compressor {
    ...
    /**
     * If a write would exceed the capacity of the direct buffers, it is set aside to be loaded by
     * this function while the compressed data are consumed.
     */

...
public class ZlibCompressor implements Compressor {
    ...
    public static enum CompressionStrategy {
        /**
         * Compression strategy best used for data consisting mostly of small values with a somewhat
         * random distribution. Forces more Huffman coding and less string matching.
         */
        FILTERED(1),
        ...
        /**
         * Compression strategy to prevent the use of dynamic Huffman codes, allowing for a simpler
    ...
    /**
     * Creates a new compressor using the specified compression level. Compressed data will be
     * generated in ZLIB format.
     *
    ...
    /**
     * IMPORTANT: This compressor allocates off-heap memory that will not be freed unless and until
     * this method is called. Java's garbage collection system will not do anything to help with
     * this.
     */
    ...
    private static native long init(int level, int strategy, int windowBits);

...
#include "com_indeed_util_compress_zlib_ZlibCompressor.h"
...
Java_com_indeed_util_compress_zlib_ZlibCompressor_initIDs(
...
Java_com_indeed_util_compress_zlib_ZlibCompressor_init(
...
JNIEXPORT void JNICALL
Java_com_indeed_util_compress_zlib_ZlibCompressor_setDictionary(
...
Java_com_indeed_util_compress_zlib_ZlibCompressor_deflateBytesDirect(
...
JNIEXPORT jlong JNICALL
Java_com_indeed_util_compress_zlib_ZlibCompressor_getBytesRead(
	JNIEnv *env, jclass class, jlong stream
	) {
...
JNIEXPORT jlong JNICALL
Java_com_indeed_util_compress_zlib_ZlibCompressor_getBytesWritten(
	JNIEnv *env, jclass class, jlong stream
	) {
...
JNIEXPORT void JNICALL
Java_com_indeed_util_compress_zlib_ZlibCompressor_reset(
	JNIEnv *env, jclass class, jlong stream
	) {
...
JNIEXPORT void JNICALL
Java_com_indeed_util_compress_zlib_ZlibCompressor_end(
	JNIEnv *env, jclass class, jlong stream
	) {
